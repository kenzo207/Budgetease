...
class $TransactionsTable extends Transactions
  ...
  static const VerificationMeta _sourceWalletMeta =
      const VerificationMeta('sourceWallet');
  @override
  late final GeneratedColumnWithTypeConverter<WalletType, int> sourceWallet =
      GeneratedColumn<int>('source_wallet', aliasedName, false,
              type: DriftSqlType.int, requiredDuringInsert: true)
          .withConverter<WalletType>($TransactionsTable.$convertersourceWallet);
  static const VerificationMeta _destinationWalletMeta =
      const VerificationMeta('destinationWallet');
  @override
  late final GeneratedColumnWithTypeConverter<WalletType, int>
      destinationWallet = GeneratedColumn<int>(
              'destination_wallet', aliasedName, false,
              type: DriftSqlType.int,
              requiredDuringInsert: false,
              defaultValue: const Constant(5))
          .withConverter<WalletType>(
              $TransactionsTable.$converterdestinationWallet);
  static const VerificationMeta _noteMeta = const VerificationMeta('note');
  @override
  late final GeneratedColumn<String> note = GeneratedColumn<String>(
      'note', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _isShieldRelatedMeta =
      const VerificationMeta('isShieldRelated');
  @override
  late final GeneratedColumn<bool> isShieldRelated = GeneratedColumn<bool>(
      'is_shield_related', aliasedName, false,
  ...
  late final GeneratedColumn<DateTime> createdAt = GeneratedColumn<DateTime>(
      ...
      type: DriftSqlType.dateTime, requiredDuringInsert: true);
  static const VerificationMeta _incomeFrequencyMeta =
      const VerificationMeta('incomeFrequency');
  @override
  late final GeneratedColumn<String> incomeFrequency = GeneratedColumn<String>(
      'income_frequency', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _shadowSavingsMeta =
      const VerificationMeta('shadowSavings');
  @override
  late final GeneratedColumn<double> shadowSavings = GeneratedColumn<double>(
      'shadow_savings', aliasedName, false,
  ...
  VerificationContext validateIntegrity(Insertable<TransactionData> instance,
    ...
    context.handle(_sourceWalletMeta, const VerificationResult.success());
    context.handle(_destinationWalletMeta, const VerificationResult.success());
    ...
    if (data.containsKey('is_shield_related')) {
      context.handle(
          ...
          isShieldRelated.isAcceptableOrUnknown(
              data['is_shield_related']!, _isShieldRelatedMeta));
    }
    ...
    if (data.containsKey('income_frequency')) {
      context.handle(
          ...
          incomeFrequency.isAcceptableOrUnknown(
              data['income_frequency']!, _incomeFrequencyMeta));
    }
    if (data.containsKey('shadow_savings')) {
      context.handle(
          _shadowSavingsMeta,
          shadowSavings.isAcceptableOrUnknown(
              data['shadow_savings']!, _shadowSavingsMeta));
    }
    return context;
  }
    ...
    return TransactionData(
      ...
      sourceWallet: $TransactionsTable.$convertersourceWallet.fromSql(
          attachedDatabase.typeMapping.read(
              DriftSqlType.int, data['${effectivePrefix}source_wallet'])!),
      destinationWallet: $TransactionsTable.$converterdestinationWallet.fromSql(
          attachedDatabase.typeMapping.read(
              DriftSqlType.int, data['${effectivePrefix}destination_wallet'])!),
      note: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}note']),
      isShieldRelated: attachedDatabase.typeMapping.read(
          DriftSqlType.bool, data['${effectivePrefix}is_shield_related'])!,
      createdAt: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}created_at'])!,
      incomeFrequency: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}income_frequency']),
      shadowSavings: attachedDatabase.typeMapping
          .read(DriftSqlType.double, data['${effectivePrefix}shadow_savings'])!,
    );
  }
...
class TransactionData extends DataClass implements Insertable<TransactionData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['destination_wallet'] = Variable<int>($TransactionsTable
          .$converterdestinationWallet
          .toSql(destinationWallet));
    }
  ...
  factory TransactionData.fromJson(Map<String, dynamic> json,
    ...
    return TransactionData(
      ...
      sourceWallet: $TransactionsTable.$convertersourceWallet
          .fromJson(serializer.fromJson<int>(json['sourceWallet'])),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'destinationWallet': serializer.toJson<int>($TransactionsTable
          .$converterdestinationWallet
...
class $WalletsTable extends Wallets with TableInfo<$WalletsTable, WalletData> {
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, type, balance, icon, color, isActive, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class WalletsCompanion extends UpdateCompanion<WalletData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (type.present) {
      map['type'] =
          Variable<int>($WalletsTable.$convertertype.toSql(type.value));
    }
    if (balance.present) {
...
class $ShieldItemsTable extends ShieldItems
  ...
  late final GeneratedColumnWithTypeConverter<RecurrenceFrequency, int>
      frequency = GeneratedColumn<int>('frequency', aliasedName, false,
          ...
          .withConverter<RecurrenceFrequency>(
              $ShieldItemsTable.$converterfrequency);
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, type, name, amount, frequency, dueDate, isPaid, isActive, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  VerificationContext validateIntegrity(Insertable<ShieldItemData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  ShieldItemData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ShieldItemData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      type: $ShieldItemsTable.$convertertype.fromSql(attachedDatabase
          .typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}type'])!),
      name: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}name'])!,
      amount: attachedDatabase.typeMapping
          .read(DriftSqlType.double, data['${effectivePrefix}amount'])!,
      frequency: $ShieldItemsTable.$converterfrequency.fromSql(attachedDatabase
          .typeMapping
...
class ShieldItemData extends DataClass implements Insertable<ShieldItemData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['frequency'] =
          Variable<int>($ShieldItemsTable.$converterfrequency.toSql(frequency));
    }
  ...
  factory ShieldItemData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ShieldItemData(
      id: serializer.fromJson<int>(json['id']),
      type: $ShieldItemsTable.$convertertype
          .fromJson(serializer.fromJson<int>(json['type'])),
      name: serializer.fromJson<String>(json['name']),
      amount: serializer.fromJson<double>(json['amount']),
      frequency: $ShieldItemsTable.$converterfrequency
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'type':
          serializer.toJson<int>($ShieldItemsTable.$convertertype.toJson(type)),
      'name': serializer.toJson<String>(name),
      'amount': serializer.toJson<double>(amount),
      'frequency': serializer
          .toJson<int>($ShieldItemsTable.$converterfrequency.toJson(frequency)),
...
class ShieldItemsCompanion extends UpdateCompanion<ShieldItemData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (type.present) {
      map['type'] =
          Variable<int>($ShieldItemsTable.$convertertype.toSql(type.value));
    }
    if (name.present) {
      map['name'] = Variable<String>(name.value);
    }
...
class $DailySnapshotsTable extends DailySnapshots
  ...
  late final GeneratedColumn<DateTime> date = GeneratedColumn<DateTime>(
      'date', aliasedName, false,
      type: DriftSqlType.dateTime, requiredDuringInsert: true);
  static const VerificationMeta _dailyCapMeta =
      const VerificationMeta('dailyCap');
  @override
  late final GeneratedColumn<double> dailyCap = GeneratedColumn<double>(
      'daily_cap', aliasedName, false,
      type: DriftSqlType.double, requiredDuringInsert: true);
  ...
  late final GeneratedColumn<double> remaining = GeneratedColumn<double>(
      ...
      type: DriftSqlType.double, requiredDuringInsert: true);
  static const VerificationMeta _carryOverMeta =
      const VerificationMeta('carryOver');
  @override
  late final GeneratedColumn<double> carryOver = GeneratedColumn<double>(
      'carry_over', aliasedName, false,
      type: DriftSqlType.double,
      requiredDuringInsert: false,
      defaultValue: const Constant(0.0));
  static const VerificationMeta _wasCarriedOverMeta =
      const VerificationMeta('wasCarriedOver');
  @override
  late final GeneratedColumn<bool> wasCarriedOver = GeneratedColumn<bool>(
      'was_carried_over', aliasedName, false,
      type: DriftSqlType.bool,
      requiredDuringInsert: false,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
  ...
  @override
  VerificationContext validateIntegrity(Insertable<DailySnapshotData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
    ...
    if (data.containsKey('was_carried_over')) {
      context.handle(
          ...
          wasCarriedOver.isAcceptableOrUnknown(
              data['was_carried_over']!, _wasCarriedOverMeta));
    }
    if (data.containsKey('created_at')) {
      context.handle(_createdAtMeta,
          createdAt.isAcceptableOrUnknown(data['created_at']!, _createdAtMeta));
  ...
  DailySnapshotData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DailySnapshotData(
      ...
      date: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}date'])!,
      dailyCap: attachedDatabase.typeMapping
          .read(DriftSqlType.double, data['${effectivePrefix}daily_cap'])!,
      ...
      carryOver: attachedDatabase.typeMapping
          .read(DriftSqlType.double, data['${effectivePrefix}carry_over'])!,
      wasCarriedOver: attachedDatabase.typeMapping
          .read(DriftSqlType.bool, data['${effectivePrefix}was_carried_over'])!,
      createdAt: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}created_at'])!,
    );
  }
...
class DailySnapshotData extends DataClass
  ...
  factory DailySnapshotData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return DailySnapshotData(
      id: serializer.fromJson<int>(json['id']),
  ...
  @override
  int get hashCode => Object.hash(id, date, dailyCap, totalSpent, remaining,
      carryOver, wasCarriedOver, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $SettingsTable extends Settings
  ...
  late final GeneratedColumn<bool> darkMode = GeneratedColumn<bool>(
      ...
      defaultValue: const Constant(true));
  static const VerificationMeta _privacyModeMeta =
      const VerificationMeta('privacyMode');
  @override
  late final GeneratedColumn<bool> privacyMode = GeneratedColumn<bool>(
      'privacy_mode', aliasedName, false,
      type: DriftSqlType.bool,
      requiredDuringInsert: false,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'CHECK ("privacy_mode" IN (0, 1))'),
      defaultValue: const Constant(false));
  static const VerificationMeta _shadowSavingsRateMeta =
      const VerificationMeta('shadowSavingsRate');
  @override
  late final GeneratedColumn<double> shadowSavingsRate =
      GeneratedColumn<double>('shadow_savings_rate', aliasedName, false,
          type: DriftSqlType.double,
          requiredDuringInsert: false,
          defaultValue: const Constant(0.1));
  @override
  List<GeneratedColumn> get $columns =>
      [id, currency, darkMode, privacyMode, shadowSavingsRate];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  SettingData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SettingData(
      ...
      privacyMode: attachedDatabase.typeMapping
          .read(DriftSqlType.bool, data['${effectivePrefix}privacy_mode'])!,
      shadowSavingsRate: attachedDatabase.typeMapping.read(
          DriftSqlType.double, data['${effectivePrefix}shadow_savings_rate'])!,
    );
  }
...
class SettingData extends DataClass implements Insertable<SettingData> {
  ...
  SettingData copyWithCompanion(SettingsCompanion data) {
    return SettingData(
      ...
      privacyMode:
          data.privacyMode.present ? data.privacyMode.value : this.privacyMode,
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [transactions, wallets, shieldItems, dailySnapshots, settings];
  @override
...
class $$TransactionsTableFilterComposer
  ...
  ColumnFilters<double> get shadowSavings => $composableBuilder(
      column: $table.shadowSavings, builder: (column) => ColumnFilters(column));
}
...
typedef $$WalletsTableProcessedTableManager = ProcessedTableManager<
    ...
    WalletData,
    PrefetchHooks Function()>;
typedef $$ShieldItemsTableCreateCompanionBuilder = ShieldItemsCompanion
    Function({
  Value<int> id,
  required ShieldType type,
  required String name,
...
typedef $$ShieldItemsTableUpdateCompanionBuilder = ShieldItemsCompanion
    Function({
  Value<int> id,
  Value<ShieldType> type,
  Value<String> name,
...
class $$ShieldItemsTableTableManager extends RootTableManager<
    _$AppDatabase,
    $ShieldItemsTable,
    ShieldItemData,
    $$ShieldItemsTableFilterComposer,
...
typedef $$ShieldItemsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $ShieldItemsTable,
    ShieldItemData,
    $$ShieldItemsTableFilterComposer,
...
class $$DailySnapshotsTableFilterComposer
  ...
  ColumnFilters<double> get dailyCap => $composableBuilder(
      column: $table.dailyCap, builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<double> get carryOver => $composableBuilder(
      column: $table.carryOver, builder: (column) => ColumnFilters(column));
...
class $$DailySnapshotsTableOrderingComposer
  ...
  ColumnOrderings<double> get dailyCap => $composableBuilder(
      column: $table.dailyCap, builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<double> get carryOver => $composableBuilder(
      column: $table.carryOver, builder: (column) => ColumnOrderings(column));
...
class $$DailySnapshotsTableAnnotationComposer
  ...
  GeneratedColumn<bool> get wasCarriedOver => $composableBuilder(
      column: $table.wasCarriedOver, builder: (column) => column);
...
class $$SettingsTableFilterComposer
  ...
  ColumnFilters<bool> get privacyMode => $composableBuilder(
      column: $table.privacyMode, builder: (column) => ColumnFilters(column));
...
class $$SettingsTableOrderingComposer
  ...
  ColumnOrderings<bool> get privacyMode => $composableBuilder(
      column: $table.privacyMode, builder: (column) => ColumnOrderings(column));
...
class $$SettingsTableAnnotationComposer
  ...
  GeneratedColumn<bool> get privacyMode => $composableBuilder(
      column: $table.privacyMode, builder: (column) => column);

  GeneratedColumn<double> get shadowSavingsRate => $composableBuilder(
      column: $table.shadowSavingsRate, builder: (column) => column);
}
