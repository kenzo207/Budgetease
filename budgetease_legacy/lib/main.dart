...
import 'package:budgetease_flutter/services/database_service.dart';
import 'package:budgetease_flutter/screens/vertical_home_screen_hive.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        home: const VerticalHomeScreenHive(),
      ),
    );
  }
}
